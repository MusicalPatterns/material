// import { as, elementExists, Ms, Point, sleep, Translation } from '@musical-patterns/utilities'
// import { page } from '../setup'
//
// const FOR_SOME_REASON_WE_NEED_TO_WAIT_A_SPLIT_SECOND_BEFORE_CHECKING: Translation<Point<Ms>> = as.Translation<Point<Ms>>(100)
//
// describe('it starts', () => {
